...
Typically, you will need to create the decoder.  The various decoder data definitions are available at our web site. The latest decoder document can be found at :
myutilities.net/decoder
